...
public class MergeSort {
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(Queue<Item> items) {
        Queue<Item> result = new Queue<>();
        Queue<Queue<Item>> singledItems = makeSingleItemQueues(items);

        Queue<Item> q1 = null;
        while (!singledItems.isEmpty()) {
            q1 = singledItems.dequeue();
            result = mergeSortedQueues(q1, result);
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Printing original queue:");
